...
class _AboutWidgetState extends State<AboutWidget> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildLegalSection(isDesktop, theme),
  ...
  Widget _buildLegalSection(bool isDesktop, FlutterFlowTheme theme) {
    return Container(
        ...
        child: Column(
          children: [
            ...
            Wrap(
              ...
              alignment: WrapAlignment.center,
              children: [
                _textLink('Términos y Condiciones',
                    () => context.pushNamed('terms'), theme),
                _textLink('Política de Privacidad',
                    () => context.pushNamed('privacy_policy'), theme),
                _textLink('Centro de Ayuda', () => context.pushNamed('support'),
                    theme),
              ],
            ),
          ],
  ...
  Widget _textLink(String text, VoidCallback onTap, FlutterFlowTheme theme) {
    return InkWell(
      onTap: onTap,
      child: Text(
        text,
