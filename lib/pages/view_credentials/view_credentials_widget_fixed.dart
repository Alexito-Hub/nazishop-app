...
class _ViewCredentialsWidgetState extends State<ViewCredentialsWidget> {
  ...
  Widget _buildMobileLayout(FlutterFlowTheme theme, bool isDark) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(24),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildServiceInfoCard(theme: theme, isDark: isDark),
          ...
          const SizedBox(height: 24),
          _buildCredentialsContent(theme, isDark),
          const SizedBox(height: 24),
          _buildWarningCard(theme, isDark),
          const SizedBox(height: 32),
          _buildSupportButton(theme, isDark),
  ...
  // 💻 DESKTOP LAYOUT
  // ===========================================================================
  Widget _buildDesktopLayout(FlutterFlowTheme theme, bool isDark) {
    return Stack(
      children: [
        // Back Button
        Positioned(
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _buildInfoItem('Estado', 'Activo', theme.success,
  ...
  Widget _buildCredentialsContent(FlutterFlowTheme theme, bool isDark) {
  ...
  Widget _buildWarningCard(FlutterFlowTheme theme, bool isDark) {
    return Container(
  ...
  Widget _buildSupportButton(FlutterFlowTheme theme, bool isDark) {
    return Align(
